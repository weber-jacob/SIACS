#------SAPRC 07T Chemical mechanism
#----Version for SIACS 0924
#---------------------------!!!! This is only a placeholder copy, identical to SAPRC99, pending SAPRC07T mechanism work in KPP !!!!!---------------

ReturnRCT.SAPRC07T <- function(J, Ti, cfactor) {
  ...
  if(SIACS.env$chemistry == FALSE) return (rep(0,nrxn))
...
Reaction.Rates.SAPRC07T <- function (RCT,y,p,O2,H2) {
  AR[1] <- RCT[1]*y[70] ;
  ...
  return(AR)
} #Reaction.Rates.SAPRC07T

Reactions.Sum.SAPRC07T <- function(AR) {
...
Jacobian.reaction.components.SAPRC07T <- function (RCT,y,p,O2,H2) {
  ...
  B[317] = RCT[183] ;
  ## B[318] = dAR[184]/dy[74]
  B[318] = RCT[184]*y[75] ; #shc modified for CH4
  ## B[319] = dAR[184]/d[75] #shc added for CH4
  B[319] = RCT[184]*y[74] ; #shc added for CH4
  ## B[320] = dAR[185]/dy[44]
  B[320] = RCT[185]*y[74] ;
  ## B[321] = dAR[185]/dy[74]
  B[321] = RCT[185]*y[44] ;
  ...
  B[373] = RCT[211]*y[53] ;
  return(B)
} #Jacobian.reaction.components.SAPRC07T

Jacobian.Terms.SAPRC07T <- function (B) {
  njacentries <- 920
